...
// Affiche fenetre d'ajout de séance
	...
	function ChangingSizeFullCalendar() {
		...
		var heightPage = document.getElementById('MainCalendar').clientHeight;
		
		var sizeSidebar = document.getElementById('sidebar');
		
		heightPage = heightPage +8;
		
		sizeSidebar.style.height = heightPage+"px";
	}
