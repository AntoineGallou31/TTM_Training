...
<link rel='stylesheet' href='CSS/trainer_main.css'/>
...
<body id="body">
	...
	<div id="sidebar">
		<div class="sidedarContainerTitle">
				<span class="sidedarTitle">Mes Athl&egrave;tes</span>
			</div>
			
			<div class="search_container">
			      <input id="SidebarInputText" type="text" placeholder="Rechercher" name="search" autocomplete="off">
			      <button id="SidebarButtonSearch"></button>
			</div>
	...
	<div id="MainCalendar">
             ...
             <div id="ModalRepetitionChoice1Container">
            	...
            	<div id="ModalRepetitionChoice2Input">
            		<div id="input1">
        	        	...
        	        	<label for="EndUntilWeek">Apr&egrave;s <input id="inputEndUntilWeek" type="number"min="1" max="100"value="10"> occurrence(s) </label>
                	</div>
    		...
    		<form id="add_activity_form2">
    			...
    			<div class="windowAddActivity">
    				...
    				<div class="input_style_text">
        				...
        				<input type="text" id="activityTitle1" class="activityTitleStyle" autocomplete="off" required>
    				</div>
    	...
    	<div id="id01" class="modal">
    		<form class="modal-content animate" id="add_activity_form">
    			<span class="close" title="Close Modal" id="CloseModalAddActivity">&times;</span>
    			...
    			<div class="windowAddActivity">
    				...
    				<div class="input_style_text">
        				...
        				<input list="datalist" type="text" id="activityTitle" class="activityTitleStyle" autocomplete="off" oninvalid="alert('Veuillez renseigner le type d\'activité');" required>
        				<datalist id="datalist">
    					  <option value="Footing">
    					  <option value="Natation club">
    					  <option value="Sortie Club">
    					  <option value="Séance VMA">
    					</datalist>
    				</div>
    				...
    				<div class="input_style_radio">
        				...
        				<div  class="activityInline">
            				<div class="element">
            					<input id="activityType1" name="act_type" type="radio" value="Entrainement" oninvalid="alert('Veuillez renseigner le sport');" required>
    				...
    				<div class="input_style_radio">
        				...
        				<div class="colum1">
            				<div class="element">
            				    <input id="activitySport1" name="act_sport" type="radio" value="Natation" required>
    				...
    				<div id="input_submit">
    					<input id="input_submit_add_activity"type="button" name="Submit" value="Ajouter l'activit&eacute;">
    				</div>
	...
	<footer>
		...
		<script type="text/javascript" src="Javascript/trainer_modify.js"></script>
		<script type="text/javascript" src="Javascript/trainer_activity.js"></script>
		<script type="text/javascript" src="Javascript/trainer_main.js"></script>
		<script type="text/javascript" src="Javascript/trainer_recap.js"></script>
		<script type="text/javascript" src="Javascript/trainer_calendar.js"></script>
